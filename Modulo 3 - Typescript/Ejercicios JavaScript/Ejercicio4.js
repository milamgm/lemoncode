/**
 *Crear funcion para normalizar una colección de objetos a un objeto, de tal manera que devuelva un objeto 
 que tenga como claves las ids de los objetos y como valores los objetos en sí pero sin la id. 
 */
...
const normalize = (arr) => {
  return arr.reduce((collectionObj, user) => {
    const { id, ...userWithoutId } = user;
    return { ...collectionObj, [id]: userWithoutId };
  }, {});
};
